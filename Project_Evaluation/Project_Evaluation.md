...
In future development, the team should increase its commitment to object-orientated programming. This will allow the entire project to further benefit from: code simplicity gains from widespread inheritance, code readability and tidiness gains from abstraction and reduction in redundant code from polymorphism. The current code in all three platforms is relatively rudimentary, therefore the concepts of inheritance, interfaces and polymorphism did not appear to be of significant relevance weighed up against our dedication to making the system work. However as the code becomes more complicated, those measures will be more necessary to sustain the readability and maintainabiltiy of the programs. 
