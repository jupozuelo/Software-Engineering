...
uint8_t guestMacAddress[6] = {0xF8, 0xFF, 0xC2, 0x32, 0x95, 0xC9};
...
const char* MQTT_sub_topic = "Juanworld"; // pub/sub topics
const char* MQTT_pub_topic = "Juanworld"; // You might want to create your own
