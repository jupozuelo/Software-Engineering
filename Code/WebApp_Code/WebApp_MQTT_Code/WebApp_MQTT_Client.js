...
//bathId, request, request_information, review, bath_placed_at, bath_status
...
function placeOrder() {
  ...
  bath_id: "O" + makeid(7),
  bath_status: x.elements[1].value,
  bath: {
		user_name: x.elements[2].value,
  	   bath_placed_at: x.elements[3].value,
	},
  request_time: x.elements[4].value,
  desired_temperature: x.elements[5].value,
  bath_bubbles: x.elements[6].value,
  bath_depth: x.elements[7].value };
