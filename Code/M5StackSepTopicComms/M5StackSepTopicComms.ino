...
const char* MQTT_sub_topic = "kit"; // pub/sub topics
const char* MQTT_pub_topic = "kit"; // You might want to create your own
...
//delay to fix strange issue with buttonA automatically firing (found in online documentation)
delay(10);
...
void setupScreen(){
    ...
    M5.Lcd.drawCentreString("bubble", 165, 40, 2);
